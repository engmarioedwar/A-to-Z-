/* ═══════════════════════════════════════════════════════════
   AIDS SOC Platform  —  intro.js  (v2 — Mobile Optimized)
═══════════════════════════════════════════════════════════ */
...
(function () {
  ...
  const BLOCK_DATA = [
    ...
    { label: 'AI PIPELINE',   sub: 'Automated Training Engine', hex: '#b66bff', side: -1 },
    { label: 'AI COPILOT',    sub: 'Conversational Assistant',  hex: '#00e5ff', side:  1 },
  ];
  ...
  function loop() {
    ...
    tunnelSpeed = Math.min(tunnelSpeed + SPEED_STEP, MAX_SPEED);
  ...
  function showMain() {
    ...
    if (window.initPipelineMini) initPipelineMini();
    if (window.initCopilotMini)  initCopilotMini();
  }
